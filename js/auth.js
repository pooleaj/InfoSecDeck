...
function _makeLottie(src) {
  return '<lottie-player src="' + src + '" background="transparent" speed="1" style="width:160px;height:120px;margin:0 auto;display:block;" loop autoplay></lottie-player>';
}
var _roleAnims = {
  iam:     _makeLottie('https://assets-v2.lottiefiles.com/a/e18615d0-1165-11ee-862b-27f756228ec7/XRrRsZkN5s.json'),
  soc:     _makeLottie('https://assets-v2.lottiefiles.com/a/d83e616c-1188-11ee-879f-73f8c72f788f/GoAJ6fK03E.json'),
  red:     _makeLottie('https://assets-v2.lottiefiles.com/a/1d4bbbb0-1184-11ee-9ed1-c3216eecf4f8/K0eFOucljU.json'),
  grc:     _makeLottie('https://assets-v2.lottiefiles.com/a/b37e402a-118a-11ee-8e10-cfe9128e59f8/HJmt14d91G.json'),
  cloud:   _makeLottie('https://assets-v2.lottiefiles.com/a/d5e2146c-5f12-11ef-8407-6f2d7f3765d2/ekWZCdqryx.json'),
  default: _makeLottie('https://assets-v2.lottiefiles.com/a/fd3301a4-117d-11ee-abfe-cb4e710bf2eb/WWm0dTaapL.json')
};
_roleAnims.forensics = _roleAnims.soc;
_roleAnims.eng       = _roleAnims.default;
_roleAnims.appsec    = _roleAnims.red;
_roleAnims.ciso      = _roleAnims.grc;
_roleAnims.aisec     = _makeLottie('https://assets-v2.lottiefiles.com/a/e2ecd824-117d-11ee-b9f7-b3a9b147ed5d/e990WrDEDS.json');
